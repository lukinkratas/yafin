...
class TimeseriesResult(TypedDict):
    ...
    annualCashDividendsPaid: NotRequired[list[TimeseriesResultItem]]
    ...
    annualCommonStockDividendPaid: NotRequired[list[TimeseriesResultItem]]
    annualCommonStockEquity: NotRequired[list[TimeseriesResultItem]]
    annualCommonStockIssuance: NotRequired[list[TimeseriesResultItem]]
    ...
    annualCurrentAccruedExpenses: NotRequired[list[TimeseriesResultItem]]
    ...
    annualGrossAccountsReceivable: NotRequired[list[TimeseriesResultItem]]
    ...
    annualIssuanceOfCapitalStock: NotRequired[list[TimeseriesResultItem]]
    ...
    annualLongTermDebt: NotRequired[list[TimeseriesResultItem]]
    ...
    annualOtherunderPreferredStockDividend: NotRequired[list[TimeseriesResultItem]]
    ...
    annualTreasurySharesNumber: NotRequired[list[TimeseriesResultItem]]
...
class RatingsResponseJson(TypedDict):
    dir: RatingsItem
    mm: RatingsItem
    pt: RatingsItem
