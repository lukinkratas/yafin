...
- More, than 15x faster, than other Yahoo finance clients. Run the tests yourself - `make test-perf` (All tests running synchronously and returning pandas DataFrame.)
